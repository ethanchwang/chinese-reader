    ...
    def _load_dictionary(self):
        ...
        try:
            with open(self.dict_file, 'r', encoding='utf-8') as f:
                ...
                print(f"Dictionary loaded: {entry_count} entries, {len(self.entries)} unique phrases")
        except FileNotFoundError:
            print(f"Warning: Dictionary file {self.dict_file} not found. Dictionary will be empty.")
            self.entries = {}
            ...
            for vowel in ['a', 'e', 'o', 'i', 'u', 'ü']:
                if vowel in syllable_no_tone:
                    ...
                    if vowel_char in tone_marks:
                        ...
                        return syllable_no_tone[:idx] + new_vowel + syllable_no_tone[idx+1:]
